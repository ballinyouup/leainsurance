...
export const metadata: Metadata = {
	title: "Medicare",
	description:
		"En Lea Insurance, comprendemos la importancia de la buena salud y la seguridad financiera. Es por eso que ofrecemos una variedad de opciones de seguro, que incluyen Obamacare, Medicare, asistencia funeraria y seguro de vida. Nuestro compromiso con la excelencia en el servicio al cliente significa que puede confiar en nosotros para atender todas sus necesidades de seguros.",
	keywords: [
		"Medicare, Seguro médico, Servicios de salud, Medicare FL, Medicare Broward, Medicare Miami, Seguro médico Miami, Seguro médico Broward",
	],
};
