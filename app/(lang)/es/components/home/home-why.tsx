	...
	return (
		<section className="z-10 flex w-full flex-col items-center justify-center gap-6 bg-background lg:items-start">
			<WhyCard
				...
				text={
					"En L.E.A. Insurance, comenzamos cada relación con una conversación. Nuestros asesores te conocen y comprenden tus necesidades de atención médica, para luego recomendarte el mejor plan para ti."
				}
			...
			<WhyCard
				...
				title={"PAZ MENTAL"}
				text={
					"Siéntete tranquilo sabiendo que L.E.A Insurance estará a tu lado en todas las etapas de la vida. Ya sea que estés formando una familia o haciendo un cambio, nuestros asesores te ayudarán a ajustar tu plan según tus necesidades."
				}
			...
			<WhyCard
				...
				title={"LA CANTIDAD ADECUADA DE PROTECCIÓN"}
				text={
					"Nuestros asesores trabajarán contigo para asegurarte de que siempre tengas la cantidad adecuada de protección. Con L.E.A Insurance, puedes estar seguro de que estás obteniendo la mejor cobertura y el mejor precio disponible."
				}
