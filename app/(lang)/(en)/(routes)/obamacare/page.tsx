				...
				<div className="w-full max-w-7xl">
					...
					>
						...
						>
							<div className="flex w-full flex-col gap-4">
								...
								<span>
									...
									comprehensive healthcare reform law enacted in 2010. Its
									primary goal is to make health insurance more affordable and
									accessible for all Americans, regardless of age, income, or
									pre-existing conditions.
								</span>
								<span>
									Obamacare offers various types of cost assistance, such as
									premium tax credits, cost-sharing reduction subsidies,
									Medicaid expansion, and the Children&apos;s Health Insurance
									Program (CHIP).
								</span>
								<span>
									Obamacare also sets minimum standards for health plans, such
									as covering essential health benefits, preventive services,
						...
						>
							...
							<p className="flex flex-col gap-6 text-lg">
								...
								<span>
									...
									cost-sharing reduction subsidies. You can check your
									eligibility and apply for Obamacare through the Health
									Insurance Marketplace, which is an online platform where you
									can compare and shop for health plans. You can also apply by
									phone, by mail, or in person with the help of a trained
									assister.
								</span>
								<span>
									The open enrollment period for 2023 health plans starts on
									November 1, 2022, and ends on January 15, 2023. During this
									time, you can enroll in a new plan or change your current
									plan.
								</span>
								<span>
									If you miss the open enrollment deadline, you may still be
									able to enroll in a health plan if you qualify for a special
									enrollment period due to a life event, such as losing other
									coverage, getting married, having a baby, or based on
									estimated household income. You can also enroll in Medicaid or
									CHIP at any time if you are eligible.
								</span>
							</p>
						</TabsContent>
						<TabsContent
						...
						>
							...
							<p>
								<span>
									...
									and how much you pay out of pocket. Generally, bronze plans
									have the lowest premiums but the highest deductibles and
									copayments, while platinum plans have the highest premiums but
									the lowest deductibles and copayments. Silver plans are the
									most popular because they are eligible for both premium tax
									credits and cost-sharing reduction subsidies.
								</span>
								<ul className="list-disc">
									...
									<span>
										All Obamacare plans must also cover preventive services at
										no cost to you, such as screenings, immunizations,
										counseling, and check-ups. Additionally, all Obamacare plans
										must cover pre-existing conditions without charging you more
										or denying you coverage.
									</span>
								</ul>
							</p>
						</TabsContent>
						...
						>
							...
							<span>
								Premium tax credits are a type of cost assistance that help
								lower your monthly premium for an Obamacare plan. The amount of
								your premium tax credit depends on your household income, family
								size, and the cost of health plans in your area. You can choose
								to receive your premium tax credit in advance to lower your
								monthly premium payments or claim it when you file your federal
								income tax return.
							</span>
							<ul className="list-disc">
								<span>
									To qualify for premium tax credits, you must meet the
									following criteria:
								</span>
								<li className="ml-6">
								...
								<li className="ml-6">
									You are not eligible for other affordable health coverage,
									such as employer-sponsored insurance, Medicare, Medicaid, or
									CHIP.
								</li>
								<li className="ml-6">
						...
						>
							...
							<span>
								...
								copayments, coinsurance, and out-of-pocket maximums. The amount
								of your cost-sharing reduction subsidy depends on your household
						...
						>
							...
							<span>
								...
								coverage to low-income people, children, pregnant women,
								seniors, and people with disabilities. CHIP is a similar program
								that covers children and some pregnant women who have slightly
								higher incomes than Medicaid. Both programs are administered by
								states within federal guidelines and offer comprehensive
								benefits at little or no cost to enrollees.
							</span>
							<span>
								The ACA expanded Medicaid eligibility to nearly all adults with
								incomes up to 138% of the FPL ($18,754 for an individual or
								$38,295 for a family of four in 2023). However, the Supreme
								Court ruled that states could choose whether or not to adopt the
								expansion. As of January 2023, 41 states (including DC) have
								adopted the Medicaid expansion and 10 states have not. The
								federal government pays 90% of the cost of covering the
							...
							<span>
								...
								states to adopt the Medicaid expansion by increasing their
								regular federal matching rate by 5 percentage points for two
								years. So far, only North Carolina has taken up this offer and
								approved Medicaid expansion in March 2023, with coverage
								expected to begin in July 2023. Other non-expansion states may
								consider adopting the expansion in 2023 through legislative
								action or ballot initiatives.
							</span>
						</TabsContent>
						<TabsContent
							value="guide"
						...
						>
							...
							<ul className="list-disc">
								...
								<li className="ml-6">
									The deductible: This is the amount you pay out of pocket
								...
								<li className="ml-6">
									...
									example, if your coinsurance is 20%, you pay 20% of the cost
									and your plan pays 80%.
								</li>
								<li className="ml-6">
									The out-of-pocket maximum: This is the most you have to pay
									for covered services in a year. After you reach this limit,
									your plan pays 100% of the cost of covered services. The
									out-of-pocket maximum includes your deductible, copayments,
									and coinsurance, but not your premiums.
								</li>
								<li className="ml-6">
									The network: This is the group of providers (doctors,
									hospitals, pharmacies, etc.) that your plan contracts with to
									provide services at lower rates. You may pay more or get no
									coverage at all if you go to a provider outside your network.
								</li>
								<li className="ml-6">
									The benefits: These are the services that your plan covers.
									All Obamacare plans must cover essential health benefits and
									preventive services at no cost to you. Some plans may also
									offer additional benefits, such as dental, vision, or wellness
									programs.
								</li>
							</ul>
							...
							<ul className="list-disc">
								...
								<li className="ml-6">
									You can call the Marketplace Call Center at 1-800-318-2596
									(TTY: 1-855-889-4325) and speak to a trained representative
									who can answer your questions and help you enroll over the
									phone.
								</li>
								<li className="ml-6">
									You can visit HealthCare.gov/find-assistance/ and search by
									city and state or ZIP code to find local helpers in your
									community who can provide free in-person assistance with
									enrollment. These helpers include navigators, certified
									application counselors, agents, brokers, and other
									organizations.
								</li>
								<li className="ml-6">
							...
							<span>
								It is important to report any changes in your income or
								household size to the Marketplace as soon as possible. These
								changes may affect your eligibility for Obamacare plans and cost
								assistance, as well as your tax liability. For example, if your
								income increases, you may qualify for less premium tax credit
								and owe money when you file your taxes. If your income
								decreases, you may qualify for more premium tax credit and get a
								refund when you file your taxes. If you have a baby, get
								married, or get divorced, you may need to change your health
								plan or enroll in a new one.
							</span>
							<span>
								You can report changes in your income or household size online,
								by phone, or by mail. You can also use the Marketplace app to
								update your information. You will need to provide proof of the
								changes, such as pay stubs, tax returns, birth certificates, or
						...
						>
							...
							<span>
								...
								required by law but may enhance your health and well-being.
							...
							<ul className="list-disc">
								<li className="ml-6">
									...
									crowns, and implants. Some plans may also cover orthodontia
									for children under 19.
								</li>
								<li className="ml-6">
									Vision coverage: This benefit covers eye exams, glasses, and
									contact lenses. Some plans may also cover eye surgeries, such
									as LASIK or cataract removal.
								</li>
								<li className="ml-6">
									Wellness programs: These programs provide incentives or
									rewards for participating in healthy activities, such as
									exercise, nutrition counseling, smoking cessation, or stress
									management.
								</li>
								<li className="ml-6">
