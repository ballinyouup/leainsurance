...
const ContactCard = () => {
	...
	return (
		<div className="z-10 flex h-full w-120 flex-col items-start justify-start gap-6 rounded-xl border border-black border-opacity-25 bg-slate-100 p-6 sm:p-12">
