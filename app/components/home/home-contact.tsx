	...
	return (
		<section className="relative mt-8 flex h-full w-full items-center justify-center gap-20 px-5 lg:mt-0 lg:flex-row lg:py-20">
			...
			<svg
				...
				version="1.1"
				className="absolute -top-[1200px] z-0 h-[1600px] w-[2000px] -scale-y-125 max-[530px]:-top-[2000px] max-[530px]:h-[4000px] max-[530px]:w-[3200px] max-[364px]:-top-[2400px] lg:-top-[800px]"
			>
				<path
